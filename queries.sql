...
promo_customers AS (
    ...
    INNER JOIN sales AS s ON fp.customer_id = s.customer_id
...
INNER JOIN customers AS c ON pc.customer_id = c.customer_id
INNER JOIN sales AS s ON pc.customer_id = s.customer_id
